...
const routes: Routes = [
  ...
  {
    path: 'vendor/hotel/service_edit/:id',
    component: HotelEditServiceComponent
  },
  {
  ...
  {
    path:'vendor/restaurant/add_food_details',
    component:RestaurantAddFoodDetailsComponent
  },
  {
    path: 'vendor/restaurant/food_details',
    component: RestaurantFoodDetailsComponent
  },
